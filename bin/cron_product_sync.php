...
if (in_array('--help', $argv)) {
    ...
    echo "-------------------------------------------\n";
    echo "Uso:\n";
    echo "  php cron_product_sync.php [--dryrun=true|false] [--range=30m|1h|2d] [--force=true]\n\n";
    ...
    echo "Ejemplos:\n";
    echo "  php cron_product_sync.php --range=30m --dryrun=true\n";
    echo "  php cron_product_sync.php --force=true\n";
    echo "  php cron_product_sync.php --dryrun=false\n\n";

    exit(0);
}

// 📁 Ruta del archivo de sincronización persistente
$syncFile = __DIR__ . '/../logs/.product_sync_timestamp';
...
$lock = __DIR__ . '/product_sync.lock';
...
Logger::info("CRON: inicio sync productos", [
    'flow'      => 'product',
    'requestId' => $requestId,
    'range'     => $range,
    'desde'     => $desde,
...
try {
    ...
    Logger::info("CRON: fin sync productos", [
        'flow'      => 'product',
        'requestId' => $requestId,
        'summary'   => $res['summary'] ?? '',
        'count'     => $res['count'] ?? 0
